...
describe NylasV2::Calendar do
  ...
  describe "#events" do
    it "sets the constraints properly for getting child events" do
      ...
      events = NylasV2::EventCollection.new(model: NylasV2::Event, api: api)
      ...
      expect(event_collection).to be_a NylasV2::EventCollection

      event_collection.execute

      expect(api).to have_received(:execute).with(
        auth_method: NylasV2::HttpClient::AuthMethod::BEARER,
        headers: {},
        method: :get,
        path: "/events",
