...
describe NylasV2::Neural do
  ...
  describe "Extract Signature" do
      ...
      [
        {
          account_id: "account123",
          body:
            "This is the body<div>NylasV2 Swag</div><div>Software Engineer</div><div>123-456-8901</div>
    ...
    it "Deserializes all the attributes into Ruby objects" do
      ...
      expect(signature[0].signature).to eql("NylasV2 Swag\n\nSoftware Engineer\n\n123-456-8901\nswag@nylas.com")
      ...
      expect(signature[0].contacts.names[0].first_name).to eql("NylasV2")
    ...
    it "Converts signature contact object to a NylasV2 contact object" do
      api = instance_double(NylasV2::API, execute: data)
      neural = described_class.new(api: api)
      signature = neural.extract_signature(["abc123"])
      contact = signature[0].contacts.to_contact_object

      expect(contact.given_name).to eql("NylasV2")
