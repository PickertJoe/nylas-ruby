...
describe NylasV2::CalendarCollection do
  describe "availability" do
    it "makes a request to get single availability" do
      api = instance_double(NylasV2::API, execute: JSON.parse("{}"))

      calendar_collection = described_class.new(model: NylasV2::Calendar, api: api)
      free_busy = NylasV2::FreeBusy.new(
      ...
      open_hours = NylasV2::OpenHours.new(
