...
describe NylasV2::SchedulerCollection do
  describe "ProviderAvailability" do
    it "(getGoogleAvailability) should call the correct endpoint" do
      ...
      scheduler_collection = described_class.new(model: NylasV2::Scheduler, api: api)
  ...
  describe "Public Booking API" do
    it "(getPageBySlug) should return a Scheduler type" do
      ...
      api = instance_double(NylasV2::API, execute: scheduler_json)
      scheduler_collection = described_class.new(model: NylasV2::Scheduler, api: api)
    ...
    it "(getAvailableTimeSlots) should return an array of SchedulerTimeSlot" do
      ...
      api = instance_double(NylasV2::API, execute: scheduler_time_slots)
      scheduler_collection = described_class.new(model: NylasV2::Scheduler, api: api)
    ...
    describe "SchedulerBookingConfirmation" do
      it "(bookTimeSlot) should return a SchedulerBookingConfirmation type" do
        ...
        api = instance_double(NylasV2::API, execute: booking_confirmation)
        scheduler_collection = described_class.new(model: NylasV2::Scheduler, api: api)

        slot = NylasV2::SchedulerTimeSlot.new(
          account_id: "test-account-id",
          calendar_id: "test-calendar-id",
        ...
        timeslot_to_book = NylasV2::SchedulerBookingRequest.new(
          additional_values: {
            test: "yes"
          },
